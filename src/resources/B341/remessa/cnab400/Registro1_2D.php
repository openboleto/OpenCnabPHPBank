<?php
namespace CnabPHPBank\resources\B341\remessa\cnab400;

use CnabPHPBank\resources\generico\remessa\cnab400\Generico1;
use CnabPHPBank\RegistroRemAbstract;
use CnabPHPBank\RemessaAbstract;
...
class Registro1_2D extends Generico1
{
    ...
    protected $meta = array(
        ...
        'filler49' => array(
            ...
            'tipo' => 'alfa',
            'required' => true),
        'data_desconto2' => array(//31.3P
            'tamanho' => 6,
            'default' => '0',
            'tipo' => 'date',
            'required' => true),
        'vlr_desconto2' => array(//34.3P
            'tamanho' => 11,
            'default' => '0',
            'tipo' => 'decimal',
            'precision' => 2,
            'required' => true),
        'data_desconto3' => array(//31.3P
            'tamanho' => 6,
            'default' => '0',
            'tipo' => 'date',
            'required' => true),
        'vlr_desconto3' => array(//34.3P
            'tamanho' => 11,
            'default' => '0',
            'tipo' => 'decimal',
            'precision' => 2,
    ...
    public function inserirMulta($data)
    {
        if (isset($data['data_multa'])) {
            $class = 'CnabPHPBank\resources\\' . RemessaAbstract::$banco . '\remessa\\' . RemessaAbstract::$layout . '\Registro2';
