...
abstract class RetornoAbstract
{
    ...
    public static $linesCounter = 1; // contador de linhas
    ...
    public function __construct($banco, $layout, $data) {
        ...
        $class = '\CnabPHPBank\resources\\B' . self::$banco . '\retorno\\' . self::$layout . '\Registro0';
        self::$entryData = $data;
    ...
    public function getText() {
        ...
        $class = '\CnabPHPBank\resources\\B' . self::$banco . '\retorno\\' . self::$layout . '\Registro9';
